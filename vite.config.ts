...
export default defineConfig(({ command, mode }) => {
  ...
  const enableAllDevControls =
    isDevServer && (mode === 'controls' || mode === 'game-controls')
  const enableRetryControl =
    isDevServer && (enableAllDevControls || mode === 'retry')
  const enableSkipControl =
    isDevServer && (enableAllDevControls || mode === 'skip')
